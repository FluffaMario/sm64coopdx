...
const Gfx mario_metal_butt[] = {
	...
	gsDPSetCombineLERP(TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, COMBINED, 0, 0, 0, ENVIRONMENT),
...
const Gfx mario_metal_right_hand_cap_shared_dl_wings[] = {
    gsDPSetCombineLERP(TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, PRIMITIVE, COMBINED, COMBINED, 0, ENVIRONMENT, 0),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsSPTexture(65535, 65535, 0, 0, 1),
    gsDPSetPrimColor(0, 0, 255, 0, 0, 255),
    gsSPCopyPlayerPartToColor(G_COL_PRIM, 6, 0),
