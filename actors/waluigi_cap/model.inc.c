...
// 0x030227C0
ROM_ASSET_LOAD_VTX(waluigi_cap_seg3_vertex_030227C0, 0x00114750, 78432, 0x0001bfc0, 256);

// 0x030228C0
ROM_ASSET_LOAD_VTX(waluigi_cap_seg3_vertex_030228C0, 0x00114750, 78432, 0x0001c0c0, 240);

// 0x030229B0
ROM_ASSET_LOAD_VTX(waluigi_cap_seg3_vertex_030229B0, 0x00114750, 78432, 0x0001c1b0, 240);

// 0x03022AA0
ROM_ASSET_LOAD_VTX(waluigi_cap_seg3_vertex_03022AA0, 0x00114750, 78432, 0x0001c2a0, 144);

// 0x03022B30 - 0x03022B68
const Gfx waluigi_cap_seg3_dl_03022B30[] = {
    gsSPVertex(waluigi_cap_seg3_vertex_03022750, 7, 0),
...
const Gfx waluigi_cap_seg3_dl_03022B68[] = {
    gsSPVertex(waluigi_cap_seg3_vertex_030227C0, 16, 0),
    ...
    gsSPVertex(waluigi_cap_seg3_vertex_030228C0, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  1, 0x0),
    ...
    gsSPVertex(waluigi_cap_seg3_vertex_030229B0, 15, 0),
...
const Gfx waluigi_cap_seg3_dl_03022CC8[] = {
    gsSPVertex(waluigi_cap_seg3_vertex_03022AA0, 9, 0),
...
const Gfx waluigi_cap_seg3_dl_03022E78[] = {
    gsSPVertex(waluigi_cap_seg3_vertex_03022D38, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx waluigi_cap_seg3_dl_03022EA8[] = {
    gsSPVertex(waluigi_cap_seg3_vertex_03022DF8, 8, 0),
